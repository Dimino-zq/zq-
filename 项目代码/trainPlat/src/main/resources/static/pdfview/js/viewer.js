...
var viewPath=getRootPath();
  PDFJS.imageResourcesPath = viewPath+'/static/pdfview/css/images/';
  PDFJS.workerSrc = viewPath+'/static/pdfview/js/pdf.worker.js';
  PDFJS.cMapUrl = viewPath+'/static/pdfview/js/cmaps/';

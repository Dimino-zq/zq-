...
public class PowerFastJsonHttpMessageConverter extends AbstractHttpMessageConverter<Object> implements GenericHttpMessageConverter<Object>  {
	private final Logger LOG = LoggerFactory.getLogger(PowerFastJsonHttpMessageConverter.class);
     ...
     */
    public PowerFastJsonHttpMessageConverter() {
    ...
    protected void writeInternal(Object object, HttpOutputMessage outputMessage) throws IOException, HttpMessageNotWritableException {
        ...
        try {
            ...
            //获取结果过滤参数
            LOG.debug("hash:"+object.hashCode());
            PowerJsonFilter[] filters=FilterCache.getFilterByObjKey(object.hashCode());
            ComplexFastjsonPropertyPreFilter coustomFilter=null;
            if (null!=filters) {
            	allFilters.clear();
            	coustomFilter=new ComplexFastjsonPropertyPreFilter(filters);
            	allFilters.add(coustomFilter);

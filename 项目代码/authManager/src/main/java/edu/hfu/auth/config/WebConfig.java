...
import edu.hfu.auth.util.StringToDateConverter;
...
//		converters.add(jacksonHttpMessageConverter);
		...
		quickJsonHttpMessageConverter.setFeatures(SerializerFeature.DisableCircularReferenceDetect);
    ...
    private RequestMappingHandlerAdapter handlerAdapter;
	 ...
	 public void addInterceptors(InterceptorRegistry registry) {
		 ...
		 addInterceptor.excludePathPatterns("/timeout");
		 addInterceptor.excludePathPatterns("/error");
		 addInterceptor.excludePathPatterns("/userReqAuth");
//		 addInterceptor.excludePathPatterns("/getGrantBySysCode");
//		 addInterceptor.excludePathPatterns("/getDepartByLvl");
//		 addInterceptor.excludePathPatterns("/getDepartByLv2");
//		 addInterceptor.excludePathPatterns("/getStaffInfoByCode");
//		 addInterceptor.excludePathPatterns("/getDepartInfo");
		 addInterceptor.excludePathPatterns("/userregistration");
//		 addInterceptor.excludePathPatterns("/getAllScreStaff");
//		 addInterceptor.excludePathPatterns("/getAllSysPost"); 
//		 addInterceptor.excludePathPatterns("/updUserPassword");
		 addInterceptor.excludePathPatterns("/sysset/getOneDepart");
		 addInterceptor.excludePathPatterns("/sysset/getTwoDepart");
		 addInterceptor.excludePathPatterns("/sysset/registerStaff");
		 addInterceptor.excludePathPatterns("/postgrant/getPost");
		 
		 addInterceptor.excludePathPatterns("/static/**");//排除静态资源 // 拦截配置
